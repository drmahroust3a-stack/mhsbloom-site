...
function home(lang) {
  ...
  const L = en ? {
    ...
    h1: 'العناية بالبشرة، <span class="accent">مبسّطة.</span>',
    sub: "١٦٨٢ منتج ومكوناتها، مبسّطة بأدلة موثقة — بالعربي والإنجليزي. ولا براند يقدر يدفع عشان يغيّر تقييم.",
    t1: "١٦٨٢", l1: "منتج مبسّط", t2: "٨٢", l2: "براند", t3: "١٠٠٪", l3: "معلومة بمصدر",
    ios: "حمّلي — App Store", and: "Google Play",
    s1: ["🧴", "المنتجات، مبسّطة", "المكونات ولمين مناسب كل منتج وإيه اللي الحكم بيغطيه — كله قابل للبحث.", "تصفّحي"],
    ...
    title: "MHS BLOOM — العناية بالبشرة، مبسّطة.", desc: "مرجع مستقل للعناية بالبشرة بالعربي والإنجليزي: ١٦٨٢ منتج مبسّط، كل معلومة بمصدرها، ولا براند يقدر يدفع عشان يغيّر تقييم."
  };
