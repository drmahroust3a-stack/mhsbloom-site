...
<text x="64" y="126" font-family="${sans}" font-size="14.5" letter-spacing="3.5" fill="#93848A" font-weight="600">M H S   B L O O M   ·   ${en ? "D E C O D E D" : "مفكوك"}</text>
${nameSvg}
${chipsSvg}
