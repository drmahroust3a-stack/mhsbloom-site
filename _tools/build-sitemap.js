...
const urls = [`${SITE}/`, `${SITE}/ar/`, `${SITE}/ingredients/`, `${SITE}/ar/ingredients/`, `${SITE}/answers/`, `${SITE}/ar/answers/`, `${SITE}/stats/`, `${SITE}/ar/stats/`, `${SITE}/products/`, `${SITE}/ar/products/`, `${SITE}/ingredient-checker/`, `${SITE}/ar/ingredient-checker/`];
